...
<head>
	...
	<title>Quản lý chi tiêu cá nhân - Bảng điều khiển</title>
...
<body>
    ...
    ?>
	    ...
	    $sum_weekly_expense = $result2['weeklyexpense'];
                        ?>
					<div class="panel-body easypiechart-panel">
						<h4>Chi phí của 7 ngày gần nhất</h4>
	    ...
	    $sum_monthly_expense = $result3['monthlyexpense'];
                        ?>
					<div class="panel-body easypiechart-panel">
						<h4>Chi phí của 30 ngày gần nhất</h4>
	    ...
	    $sum_yearly_expense = $result4['yearlyexpense'];
                        ?>
					<div class="panel-body easypiechart-panel">
						<h4>Chi phí trong năm hiện tại</h4>
						<div class="easypiechart" id="easypiechart-red"
