...
<head>
	...
	<title>Quản lý chi tiêu cá nhân || Báo cáo chi phí</title>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Báo cáo chi phí</li>
			</ol>
		</div><!--/.row-->
		...
		<div class="row">
			<div class="col-lg-12">
				...
				<div class="panel panel-default">
					<div class="panel-heading">Báo cáo chi phí</div>
...
?>
<h5 align="center" style="color:blue">Báo cáo chi phí từ <?php echo $fdate?> đến <?php echo $tdate?></h5>
<hr />
