...
<head>
	...
	<title>Quản lý chi tiêu cá nhân || Quản lý người dùng</title>
              ...
              ?>
									<tbody>
										<tr>
											...
											<td><a href="adminpage.php?delid=<?php echo $row['ID']; ?>">Xoá</a>
											<td><a href="../manage-expense.php<?php $row['ID']; ?>">Xem thêm</a>
										</tr>
										<?php
		$cnt = $cnt + 1;
	} ?>
